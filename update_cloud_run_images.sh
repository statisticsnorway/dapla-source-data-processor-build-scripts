...
set +e
gcloud run deploy $PROCESSOR_NAME --image europe-north1-docker.pkg.dev/artifact-registry-14da/ssb-docker/ssb/statistikktjenester/automation/source-data/$TEAM_NAME/$FOLDER_NAME:$ENV_NAME --region europe-north1 --project $PROJECT_ID
gcloud_ret=$?
set -e
